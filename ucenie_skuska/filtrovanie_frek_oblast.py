...
# Vytvorenie nízkopriepustného filtra
rows, cols = image.shape
crow, ccol = rows // 2, cols // 2
mask = np.zeros((rows, cols, 2), np.uint8)
mask[crow-30:crow+30, ccol-30:ccol+30] = 1  # Malý stredový obdĺžnik
...
# Zobrazenie obrázkov v OpenCV oknách
cv2.imshow("Original Image", image)
cv2.imshow("Low-pass Filtered Image", img_back)

# Čakanie na stlačenie ľubovoľnej klávesy a zatvorenie okien
cv2.waitKey(0)
